        ...
        return (
                <View activePanel="mainPanel">
                    <Panel id="mainPanel">
                        ...
                        <FormLayout>
                          <FormLayoutGroup top="Расчет идеального веса по индексу Моннерота-Думайна с учетом комплекци" bottom="Поля вес, рост и возраст могут содержать только цифры.">
