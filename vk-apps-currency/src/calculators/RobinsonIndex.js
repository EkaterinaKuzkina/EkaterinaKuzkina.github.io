...
function Calculate_IMT( height, gender){
    ...
    if (gender === 'female'){ 
      callor =  49 + 1.7 *(height*0.393701 - 60);
    }
    else callor =  52 + 1.9 *(height*0.393701 - 60);
    }
        ...
        return (
                <View activePanel="mainPanel">
                    <Panel id="mainPanel">
                        ...
                        <FormLayout>
                          <FormLayoutGroup top="Расчет идеального веса по индексу Робинсона." bottom="Поля вес, рост и возраст могут содержать только цифры.">
