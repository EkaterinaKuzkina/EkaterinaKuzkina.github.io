...
function Calculate_IMT( height, gender){
    ...
    if (gender === 'female'){ 
      callor =  53.1 + 1.36*(height*0.393701-60);
    }
        ...
        return (
                <View activePanel="mainPanel">
                    <Panel id="mainPanel">
                        ...
                        <FormLayout>
                          <FormLayoutGroup top="Расчет идеального веса по индексу Миллера, который определяет вес для человека, с наименьшими рисками для здоровья. Подходит для людей старше 25 лет и младше 59" bottom="Поля вес, рост и возраст могут содержать только цифры.">
