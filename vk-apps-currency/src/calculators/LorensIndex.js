...
function Calculate_IMT( height, gender){
    ...
    if (gender === 'female'){ 
      callor =  height - 100 - ((height-150)/2);
    }
    else callor =  height - 100 - (height-150)/4;
    }
        ...
        return (
                <View activePanel="mainPanel">
                    <Panel id="mainPanel">
                        ...
                        <FormLayout>
                          <FormLayoutGroup top="Расчет идеального веса по индексу Лоренца, который определяет вес для человека, с наименьшими рисками для здоровья. Подходит для людей старше 25 лет и младше 59" bottom="Поля вес, рост и возраст могут содержать только цифры.">
