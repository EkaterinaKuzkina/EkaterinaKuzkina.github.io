...
function Calculate_IMT( height, gender){
    ...
    if (gender === 'female'){ 
      callor =  45.5 + 2.3 *(height*0.393701 - 60);
    }
    else callor =  50 + 2.3 *(height*0.393701 - 60);
    }
        ...
        return (
                <View activePanel="mainPanel">
                    <Panel id="mainPanel">
                        ...
                        <FormLayout>
                          <FormLayoutGroup top="Расчет идеального веса по индексу Девина." bottom="Поля вес, рост и возраст могут содержать только цифры.">
